...
class Pen{
    ...
    public synchronized void finishWriting(){
        System.out.println(Thread.currentThread().getName() + " finshed writing using pen "+this);
    }
}
...
class Paper{
    ...
    public synchronized void finishWriting(){
        System.out.println(Thread.currentThread().getName() + " finshed writing using paper "+this);
    }
}
